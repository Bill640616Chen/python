...
#您不能通過引用索引訪問一組中的項目，因為集合是無序的，項目沒有索引。
#But you can loop through the set items using a loop, or ask if a specified value is present in a set, by using the keyword.forin
#但是，您可以使用迴圈循環瀏覽設置的項目，或者使用關鍵字詢問集中是否存在指定值。forin
